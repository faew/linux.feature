...
apt-get -y install php7.1 php7.1-mysql php7.1-dev php7.1-soap php7.1-xml php7.1-gd php7.1-mcrypt php7.1-dba php7.1-mbstring php7.1-pgsql php7.1-sqlite3 php7.1-memcached php7.1-imagick php7.1-intl
