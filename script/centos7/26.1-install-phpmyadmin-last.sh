...
rm -f ./phpMyAdmin-4.7.7-english.tar.gz
mv phpMyAdmin-4.7.7-english pma-`pwgen -A 12 1`
cd pma-*
rm -f -R setup
...
echo "Open http://MAIN-IP/`ls -1 /var/www/empty.local/html/web/ | grep "pma-" | tail -n 1`"
