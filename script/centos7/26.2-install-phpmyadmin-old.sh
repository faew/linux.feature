...
wget https://files.phpmyadmin.net/phpMyAdmin/4.0.10.20/phpMyAdmin-4.0.10.20-english.tar.gz
tar -xvzf ./phpMyAdmin-4.0.10.20-english.tar.gz
rm -f ./phpMyAdmin-4.0.10.20-english.tar.gz
mv phpMyAdmin-4.0.10.20-english pma-`pwgen -A 12 1`
cd pma-*
rm -f -R setup
