...
yum -y install php php-opcache php-pdo php-mysql php-pear php-devel php-soap php-xml php-gd php-mcrypt php-dba php-mbstring php-pgsql php-posix php-intl php-pecl-memcache php-pecl-imagick
